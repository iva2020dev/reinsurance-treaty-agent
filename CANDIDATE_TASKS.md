...
|---|---|---|---|---|---|---|---|
| 1 | A1 | Retry/backoff resilience for the LLM call | Proposed | Deterministic | N/A | S | — |
| 2 | A2 | Grounding/assurance check on LLM output | Proposed | Hybrid | Both | M | — |
| 3 | A3 | Extraction accuracy eval suite (golden dataset) | Proposed | Hybrid | N/A | M | — |
| 4 | A4 | CI-integrated regression eval gate | Proposed | Deterministic | N/A | S | A3 |
